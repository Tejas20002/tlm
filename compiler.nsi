...
;Vars - This is probably the only thing you might need to change
  ...
  !define APPNAME "tlm" ; Also folder name as well btw
...
Section "Start Menu shortcut" smshort
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}.lnk" "$INSTDIR\${RUNFILE}" "" 

SectionEnd

Section "Desktop shortcut" deskshort

  createShortCut "$desktop\${APPNAME}.lnk" "$INSTDIR\${RUNFILE}" "" 
